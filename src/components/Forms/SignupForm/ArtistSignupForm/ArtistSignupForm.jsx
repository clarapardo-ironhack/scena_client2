                    ...
                    <Col sm={{ span: 5 }}>
                        ...
                        <InputGroup className="mb-2">
                            <InputGroup.Text id="spotify">
                                ...
                                <Form.Control type="text" placeholder="Spotify" style={{ width: '180px' }} name="spotify" value={spotify} onChange={handleInputChange} />
                            </InputGroup.Text>
                        ...
                        <InputGroup className="mb-2">
                            <InputGroup.Text id="bandcamp">
                                ...
                                <Form.Control type="text" placeholder="bandcamp" style={{ width: '180px' }} name="bandcamp" value={bandcamp} onChange={handleInputChange} />
                            </InputGroup.Text>
                    ...
                    <Col sm={{ span: 5, offset: 1 }}>
                        ...
                        <InputGroup className="mb-2">
                            <InputGroup.Text id="soundcloud">
                                ...
                                <Form.Control type="text" placeholder="Soundcloud" style={{ width: '180px' }} name="soundcloud" value={soundcloud} onChange={handleInputChange} />
                            </InputGroup.Text>
                        ...
                        <InputGroup className="mb-2">
                            <InputGroup.Text id="twitter">
                                ...
                                <Form.Control type="text" placeholder="Twitter" style={{ width: '180px' }} name="twitter" value={twitter} onChange={handleInputChange} />
                            </InputGroup.Text>
